...
class ErrorData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, title, status, code, detail, trace_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, title, status, code, detail, trace_id, *args, **kwargs):  # noqa: E501
        """ErrorData - a model defined in OpenAPI
