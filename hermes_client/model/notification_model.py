...
class NotificationModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'channel': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, body, channel, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, body, channel, *args, **kwargs):  # noqa: E501
        """NotificationModel - a model defined in OpenAPI
